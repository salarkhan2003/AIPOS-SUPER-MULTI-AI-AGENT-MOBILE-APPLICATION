    ...
    <View style={[S.root, { backgroundColor: C.bg, paddingTop: insets.top }]}>
      ...
      {sessions.length === 0 ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[S.scroll, { paddingBottom: insets.bottom + 40 }]}>
          ...
          <Text style={[S.hint, { color: C.textLight }]}>Long press a conversation to delete it</Text>
        </ScrollView>
      )}
...
const S = StyleSheet.create({
  ...
  sessionCard: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1 },
  ...
  hint: { fontSize: 11, textAlign: 'center', marginTop: 8, marginBottom: 4 },
